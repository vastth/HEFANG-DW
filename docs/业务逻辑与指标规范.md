...
| dabo_latest_date | 达播最新日期 | MAX(ads_dabo_daily_sales.sale_date) |
| dabo_revenue_30d | 近30天达播销售额 | SUM(ads_dabo_daily_sales.dabo_revenue) |
| dabo_revenue_7d | 近7天达播销售额 | SUM(ads_dabo_daily_sales.dabo_revenue) |
...
- [ ] 仓库口径对吗（总仓+云仓）？
- [ ] 达播数据是否就绪（ads_dabo_daily_sales 今日数据）？
